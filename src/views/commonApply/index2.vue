        ...
        <div class="content-box">
          <el-form ref="form" :model="form" :rules="rules" label-width="82px">
            <div class="item-with-line first-item-with-line item-with-icon icon_clock">
              ...
              <el-form-item label="申请名称" prop="typeName">
                <el-input type="input" rows="4" v-model="form.typeName" maxlength="50" placeholder="请输入"></el-input>
              </el-form-item>
...
export default {
    ...
    return {
      ...
      rules: {
        typeName: [
          ...
          { max: 50, message: '最多可输入50字', trigger: 'change' }
        ],
        comment: [
  ...
  created () {
    ...
    // this.form.typeName = pathParams.params
